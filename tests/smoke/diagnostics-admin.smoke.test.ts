...
describe('diagnostics — smoke (read-only invariant)', () => {
  ...
  test('service: только read-операции Prisma', () => {
    ...
    const forbidden = [
      ...
      'prisma.workInProgressBalance.update',
      'prisma.workInProgressBalance.create',
      'prisma.workInProgressBalance.delete',
      'prisma.workInProgressMovement.update',
      'prisma.workInProgressMovement.create',
      'prisma.workInProgressMovement.delete',
      'prisma.box.update',
      'prisma.box.create',
      'prisma.box.delete',
