...
/**
 * Значение `OrderCostEstimateLine.sourceType` для строк, порождённых
 * `OrderLogisticsLine` (ручные строки логистики во вкладке «Операции»).
 *
 * Логистика — такой же прямой расход заказа, как и прочие расходы, и
 * вкладка «Операции» давно прибавляет её к своему итогу. В смету она
 * при этом не входила вовсе, поэтому «Сводно по заказу» и смета
 * расходились с вкладкой «Операции» ровно на сумму доставки.
 */
export const ORDER_LOGISTICS_SOURCE_TYPE = 'LOGISTICS';
