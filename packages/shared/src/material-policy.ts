...
export interface ProductionMaterialLineDto {
   ...
   * курса в активной смете нет (код `MATERIAL_PRICE_USD_NO_RATE`). Это не 0 ₽ — в сумму документа
   * такая строка не входит, и показывать её надо прочерком, а не нулём (аудит движка расчёта
   * 13.09.2026, E1-7).
   */
