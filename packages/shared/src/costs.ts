 ...
 * во что это обошлось (`minutes × ставка/мин`).
 */
 ...
 * OPERATION_FINISHED` (для ОТК/ВТО accept = `OPERATION_SCAN` терминала —
 * аудит движка расчёта 13.09.2026, F1-5; для упаковки — по разрыву
 * терминальных событий) с разносом нахлёстов между одновременно
 * удерживаемыми паспортами. Простой на единицу НЕ распределяется.
 */
