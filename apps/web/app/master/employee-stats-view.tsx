...
// Пресеты периода в днях — те же, что в админском тайм-трекере, чтобы
// мастер и начальник цеха мерили одинаково. Произвольный диапазон
// по-прежнему задаётся полями `с`/`по` (они сбрасывают активный пресет).
