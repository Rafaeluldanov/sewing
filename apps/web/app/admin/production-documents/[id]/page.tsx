...
const COST_WARNING_LABELS: Record<string, string> = {
  ...
  // Решение владельца 14.09.2026: терминалы ОТК/ВТО/упаковки считаются по норме × объём.
  SALARY_NORM_MISSING:
    'у окладной операции не задана норма времени — её работа учтена в 0 ₽ (заполните норму в справочнике операций)',
