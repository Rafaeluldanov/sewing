 ...
 *
 * Замечание о точности: цена за штуку округляется здесь до 2 знаков
 * (`quotedPrice` хранится Decimal(14,4), но кнопкам хватает копеек).
 * Если «цена за упаковку» не делится на
...
/** Число → денежная строка, округление до 2 знаков (кнопкам хватает копеек). */
