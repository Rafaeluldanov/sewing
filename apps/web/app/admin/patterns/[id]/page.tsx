    ...
    >
      ...
      <div className="admin-grid-2">
        <div className="admin-stack">
          ...
          {/*
            Итог плана «техкарты → номенклатура» (этапы 1–5, 11–12.08.2026):
            состав материалов изделия живёт ЗДЕСЬ, в карточке номенклатуры.
            Именно эти строки заказ материализует в снапшот
            `OrderMaterialRequirement` при переводе в расчёт; пустая
            спецификация = гейт `ORDER_TECH_CARD_REQUIRED`.
          */}
          <AdminCard>
            <AdminSectionHeader
              icon={<Package size={18} strokeWidth={1.6} aria-hidden />}
              title="Материалы (спецификация)"
              hint="Состав материалов изделия: строки с характеристиками, правилами цвета и параметрами. Источник состава для заказа — нормы берутся из блоков выше"
            />
