 ...
 * реального времени (`PassportRealCostService`): минуты × ставка/мин.
 * Срез — ЗА ПЕРИОД по всем паспортам с событиями в окне (в т. ч. ещё не
 * выпущенным), поэтому может быть больше окладной строки матрицы
 * номенклатуры, где учтены только выпущенные паспорта (аудит движка
 * расчёта 13.09.2026, F1-11: разница подписана в UI).
 */
  ...
  return (
    <AdminCard>
      ...
      >
        ...
        Стоимость = разнесённое реальное время × ставка за минуту. Срез за
        период по всем паспортам с событиями в окне, включая ещё не
        выпущенные; в матрице номенклатуры и в итогах — только оклад
