        ...
        <AdminEmptyState
          ...
          hint={
            isDraft
              ...
              : isReadOnly
                ? 'У этого заказа не было привязано техкарты с материалами на момент расчёта.'
                : 'Нажмите «Пересчитать потребность», чтобы система собрала список материалов по лекалу и техкарте.'
          }
        />
      ) : (
