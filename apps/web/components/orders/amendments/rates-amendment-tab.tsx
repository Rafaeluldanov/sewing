 ...
 * расценку до сохранения структуры не на что. По той же причине метка «на
 * стороне» и цена размещения живут здесь, а не на холсте: они висят на
 * шаге СНИМКА маршрута.
 *
  ...
  return (
    <div data-testid="amend-rates-tab">
      <p className="admin-muted" style={{ fontSize: '0.8rem', marginTop: 0 }}>
        ...
        Операцию, которую делает подрядчик, отметьте «На стороне» и укажите
        цену размещения: по отданному объёму своя стоимость операции в план не
        берётся, а маршрут, плановое время и ЗП цеха остаются прежними.
      </p>
      <OrderRouteOverridesEditor
        orderId={orderId}
        sizes={state.sizes}
